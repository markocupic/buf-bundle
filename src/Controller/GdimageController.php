...
/**
 * Class GdimageAjaxController
 * @package Markocupic\BufBundle\Controller
 */
class GdimageAjaxController extends AbstractController
{

    /**
     * Handles ajax requests.
     * @Route("/gdimage", name="buf_bundle_gdimage_frontend", defaults={"_scope" = "frontend", "_token_check" = false})
     */
    ...
    public static function hex2dec($bgcolor)
    {
