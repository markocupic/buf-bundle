...
// Fields
$GLOBALS['TL_LANG']['tl_member']['isTeacher'] = array('Das Mitglied ist eine Lehrperson:');
$GLOBALS['TL_LANG']['tl_member']['isClassTeacher'] = array('Das Mitglied ist eine Klassenlehrperson:');
...
$GLOBALS['TL_LANG']['tl_member']['enableBirthdayAdvice'] = array('Geburtstags-Erinnerungsmail-Funktion für Klassenlehrer/in aktivieren');
$GLOBALS['TL_LANG']['tl_member']['showCommentsNotOlderThen'] = array('Zeige nur Kommentare älter als...');
